...
const AdminUserModal: React.FC<modalProps> = (props) => {
  ...
  return (
    <>
      ...
      <input type="checkbox" id="admin-user-modal" className="modal-toggle" />
      <label htmlFor="admin-user-modal" className="modal">
